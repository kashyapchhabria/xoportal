...
/**/
object role_row_level_mgmt extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply():play.twirl.api.HtmlFormat.Appendable = {
      _display_ {

Seq[Any](format.raw/*1.1*/("""<script id="rolerowlevelpermission_mgmt" type="text/html">
<section>
	<div class="row">
		<span>
			<center>
				<h2 data-bind="text:'"""),_display_(/*6.27*/Messages("admin.land.rolerow-level")),format.raw/*6.63*/("""'"></h2>
			</center>
			<br>
		<br> <span>
			...
			<ul	class="sub-nav xo-nav">
				<li class="">
					<ul>
						<li class="active">
							<select id='availableRoles' style="margin-bottom: 0px;" 
									data-bind='options: rowlevelmgmt.availableroles, optionsText: "displayText", value: rowlevelmgmt.selectedRole, optionsCaption: """"),_display_(/*21.139*/Messages("rowlevel.crud.selrole")),format.raw/*21.172*/(""""'>
							</select>
						</li>
						<li class="active">
				...
				<li class="active">
					<a title='"""),_display_(/*33.17*/Messages("rowlevel.crud.crud.create")),format.raw/*33.54*/("""' id="createRoleRlp" data-bind='click:rowlevelmgmt.showPopup' data-reveal-id="addrlpModel">
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/kashyap/xoworkspace/xoportal/xo_reporting_portal/app/com/xo/web/views/role_row_level_mgmt.scala.html
                  HASH: 681ad6348d819e4a5470a48151e9693d572b4923
