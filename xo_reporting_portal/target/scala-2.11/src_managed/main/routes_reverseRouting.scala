...
def getMsisdns(): Call = {
   import ReverseRouteContext.empty
   Call("POST", _prefix + { _defaultPrefix } + "getMsisdns")
}
...
// @LINE:20
def xossoCallBackHandler(token:String, company:String, domain:String, name:String = "", email:String = ""): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "logincallback" + queryString(List(Some(implicitly[QueryStringBindable[String]].unbind("token", token)), Some(implicitly[QueryStringBindable[String]].unbind("company", company)), Some(implicitly[QueryStringBindable[String]].unbind("domain", domain)), if(name == "") None else Some(implicitly[QueryStringBindable[String]].unbind("name", name)), if(email == "") None else Some(implicitly[QueryStringBindable[String]].unbind("email", email)))))
}
...
// @LINE:172
def disp(segment:String): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "config/disp/" + implicitly[PathBindable[String]].unbind("segment", dynamicString(segment)))
}
                        

// @LINE:170
def get_target(kpi_selected:String): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "config/get_target/" + implicitly[PathBindable[String]].unbind("kpi_selected", dynamicString(kpi_selected)))
}
                        

// @LINE:169
def update(kpi_selected:String): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "config/update/" + implicitly[PathBindable[String]].unbind("kpi_selected", dynamicString(kpi_selected)))
}
                        

// @LINE:171
def update_target(segment_name:String, kpi_selected_name:String, kpi_start_value:String, kpi_weight_value:String): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "config/update_target/" + implicitly[PathBindable[String]].unbind("segment_name", dynamicString(segment_name)) + "/" + implicitly[PathBindable[String]].unbind("kpi_selected_name", dynamicString(kpi_selected_name)) + "/" + implicitly[PathBindable[String]].unbind("kpi_start_value", dynamicString(kpi_start_value)) + "/" + implicitly[PathBindable[String]].unbind("kpi_weight_value", dynamicString(kpi_weight_value)))
}
...
// @LINE:109
def getMsisdns : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.DashboardController.getMsisdns",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "getMsisdns"})
      }
   """
)
...
def xossoCallBackHandler : JavascriptReverseRoute = JavascriptReverseRoute(
   ...
   """
      function(token,company,domain,name,email) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "logincallback" + _qS([(""" + implicitly[QueryStringBindable[String]].javascriptUnbind + """)("token", token), (""" + implicitly[QueryStringBindable[String]].javascriptUnbind + """)("company", company), (""" + implicitly[QueryStringBindable[String]].javascriptUnbind + """)("domain", domain), (name == null ? null : (""" + implicitly[QueryStringBindable[String]].javascriptUnbind + """)("name", name)), (email == null ? null : (""" + implicitly[QueryStringBindable[String]].javascriptUnbind + """)("email", email))])})
      }
   """
)
...
// @LINE:172
def disp : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.HomeController.disp",
   """
      function(segment) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "config/disp/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("segment", encodeURIComponent(segment))})
      }
   """
)
...
// @LINE:170
def get_target : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.HomeController.get_target",
   """
      function(kpi_selected) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "config/get_target/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("kpi_selected", encodeURIComponent(kpi_selected))})
      }
   """
)
...
// @LINE:169
def update : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.HomeController.update",
   """
      function(kpi_selected) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "config/update/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("kpi_selected", encodeURIComponent(kpi_selected))})
      }
   """
)
...
// @LINE:171
def update_target : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.HomeController.update_target",
   """
      function(segment_name,kpi_selected_name,kpi_start_value,kpi_weight_value) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "config/update_target/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("segment_name", encodeURIComponent(segment_name)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("kpi_selected_name", encodeURIComponent(kpi_selected_name)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("kpi_start_value", encodeURIComponent(kpi_start_value)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("kpi_weight_value", encodeURIComponent(kpi_weight_value))})
      }
   """
)
...
def index : JavascriptReverseRoute = JavascriptReverseRoute(
   "com.xo.web.controllers.HomeController.index",
   """
      function() {
...
// @LINE:109
def getMsisdns(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.DashboardController]).getMsisdns(), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.DashboardController", "getMsisdns", Seq(), "POST", """""", _prefix + """getMsisdns""")
)
...
// @LINE:20
def xossoCallBackHandler(token:String, company:String, domain:String, name:String, email:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.UserController]).xossoCallBackHandler(token, company, domain, name, email), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.UserController", "xossoCallBackHandler", Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[String]), "GET", """""", _prefix + """logincallback""")
)
...
// @LINE:172
def disp(segment:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).disp(segment), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.HomeController", "disp", Seq(classOf[String]), "GET", """""", _prefix + """config/disp/$segment<[^/]+>""")
)
                      

// @LINE:170
def get_target(kpi_selected:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).get_target(kpi_selected), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.HomeController", "get_target", Seq(classOf[String]), "GET", """""", _prefix + """config/get_target/$kpi_selected<[^/]+>""")
)
                      

// @LINE:169
def update(kpi_selected:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).update(kpi_selected), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.HomeController", "update", Seq(classOf[String]), "GET", """""", _prefix + """config/update/$kpi_selected<[^/]+>""")
)
                      

// @LINE:171
def update_target(segment_name:String, kpi_selected_name:String, kpi_start_value:String, kpi_weight_value:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).update_target(segment_name, kpi_selected_name, kpi_start_value, kpi_weight_value), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.HomeController", "update_target", Seq(classOf[String], classOf[String], classOf[String], classOf[String]), "GET", """""", _prefix + """config/update_target/$segment_name<[^/]+>/$kpi_selected_name<[^/]+>/$kpi_start_value<[^/]+>/$kpi_weight_value<[^/]+>""")
)
                      

// @LINE:168
def index(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).index(), HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.HomeController", "index", Seq(), "GET", """ Config KPI""", _prefix + """config""")
)
