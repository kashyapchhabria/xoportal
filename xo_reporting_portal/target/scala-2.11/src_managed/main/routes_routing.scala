...
// @HASH:455f07ff48c38fd5fe8286ab2f25249d17d795fa
// @DATE:Thu Feb 23 09:41:58 IST 2017
...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.UserController]).xossoCallBackHandler(fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.UserController", "xossoCallBackHandler", Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[String]),"GET", """""", Routes.prefix + """logincallback"""))
...
// @LINE:109
private[this] lazy val com_xo_web_controllers_DashboardController_getMsisdns70_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("getMsisdns"))))
private[this] lazy val com_xo_web_controllers_DashboardController_getMsisdns70_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.DashboardController]).getMsisdns(),
HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.DashboardController", "getMsisdns", Nil,"POST", """""", Routes.prefix + """getMsisdns"""))
        

// @LINE:113
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_readAll71_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates"))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_readAll71_invoker = createInvoker(
...
// @LINE:114
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_create72_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates"))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_create72_invoker = createInvoker(
...
// @LINE:115
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_read73_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_read73_invoker = createInvoker(
...
// @LINE:116
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_update74_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_update74_invoker = createInvoker(
...
// @LINE:117
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_delete75_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_delete75_invoker = createInvoker(
...
// @LINE:118
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_update76_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_update76_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).update(fakeValue[Integer]),
HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.XoConfigTemplateController", "update", Seq(classOf[Integer]),"PUT", """""", Routes.prefix + """configtemplates/$configId<[^/]+>"""))
        

// @LINE:119
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_isConfigExist77_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/search/"),DynamicPart("configShortName", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_isConfigExist77_invoker = createInvoker(
...
// @LINE:120
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_toggleActiveStatus78_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configtemplates/toggleactive/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigTemplateController_toggleActiveStatus78_invoker = createInvoker(
...
// @LINE:122
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_create79_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances"))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_create79_invoker = createInvoker(
...
// @LINE:123
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_readAllInstances80_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances"))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_readAllInstances80_invoker = createInvoker(
...
// @LINE:124
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_read81_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_read81_invoker = createInvoker(
...
// @LINE:125
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_update82_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_update82_invoker = createInvoker(
...
// @LINE:126
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_delete83_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_delete83_invoker = createInvoker(
...
// @LINE:127
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_update84_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_update84_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).update(fakeValue[Integer]),
HandlerDef(this.getClass.getClassLoader, "", "com.xo.web.controllers.XoConfigInstanceController", "update", Seq(classOf[Integer]),"PUT", """""", Routes.prefix + """configinstances/$configId<[^/]+>"""))
        

// @LINE:128
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_isConfigExist85_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/search/"),DynamicPart("configTemplateId", """[^/]+""",true),StaticPart("/"),DynamicPart("configShortName", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_isConfigExist85_invoker = createInvoker(
...
// @LINE:129
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_readAll86_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/all/"),DynamicPart("configTemplateId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_readAll86_invoker = createInvoker(
...
// @LINE:130
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_toggleActiveStatus87_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("configinstances/toggleactive/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoConfigInstanceController_toggleActiveStatus87_invoker = createInvoker(
...
// @LINE:134
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_toggleActiveStatus88_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clientjobconfigs/toggleactive/"),DynamicPart("clientId", """[^/]+""",true),StaticPart("/"),DynamicPart("jobId", """[^/]+""",true),StaticPart("/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_toggleActiveStatus88_invoker = createInvoker(
...
// @LINE:135
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_runJob89_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clientjobconfigs/runJob/"),DynamicPart("clientId", """[^/]+""",true),StaticPart("/"),DynamicPart("jobId", """[^/]+""",true),StaticPart("/"),DynamicPart("configId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_runJob89_invoker = createInvoker(
...
// @LINE:136
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_delete90_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clientjobconfigs"))))
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_delete90_invoker = createInvoker(
...
// @LINE:137
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_readAll91_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clientjobconfigs"))))
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_readAll91_invoker = createInvoker(
...
// @LINE:138
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_create92_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clientjobconfigs"))))
private[this] lazy val com_xo_web_controllers_XoClientJobConfigController_create92_invoker = createInvoker(
...
// @LINE:141
private[this] lazy val com_xo_web_controllers_XoClientController_readAll93_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("clients"))))
private[this] lazy val com_xo_web_controllers_XoClientController_readAll93_invoker = createInvoker(
...
// @LINE:144
private[this] lazy val com_xo_web_controllers_XoJobController_readAll94_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("jobs"))))
private[this] lazy val com_xo_web_controllers_XoJobController_readAll94_invoker = createInvoker(
...
// @LINE:146
private[this] lazy val com_xo_web_controllers_XOBaseController_heartBeat95_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("heartbeat"))))
private[this] lazy val com_xo_web_controllers_XOBaseController_heartBeat95_invoker = createInvoker(
...
// @LINE:149
private[this] lazy val com_xo_web_controllers_ViewGroupController_readAllAsKeyValue96_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/keyvalue"))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_readAllAsKeyValue96_invoker = createInvoker(
...
// @LINE:150
private[this] lazy val com_xo_web_controllers_ViewGroupController_toggleActiveStatus97_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/toggleactive/"),DynamicPart("viewGroupId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_toggleActiveStatus97_invoker = createInvoker(
...
// @LINE:151
private[this] lazy val com_xo_web_controllers_ViewGroupController_delete98_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/"),DynamicPart("viewGroupId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_delete98_invoker = createInvoker(
...
// @LINE:152
private[this] lazy val com_xo_web_controllers_ViewGroupController_readAll99_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/all"))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_readAll99_invoker = createInvoker(
...
// @LINE:153
private[this] lazy val com_xo_web_controllers_ViewGroupController_read100_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/"),DynamicPart("viewGroupId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_read100_invoker = createInvoker(
...
// @LINE:154
private[this] lazy val com_xo_web_controllers_ViewGroupController_create101_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup"))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_create101_invoker = createInvoker(
...
// @LINE:155
private[this] lazy val com_xo_web_controllers_ViewGroupController_update102_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/update"))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_update102_invoker = createInvoker(
...
// @LINE:156
private[this] lazy val com_xo_web_controllers_ViewGroupController_readGroupCount103_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("viewgroup/groupcount/"),DynamicPart("viewGroupId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_ViewGroupController_readGroupCount103_invoker = createInvoker(
...
// @LINE:159
private[this] lazy val com_xo_web_controllers_TableauViewController_readAllAsKeyValue104_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/keyvalue"))))
private[this] lazy val com_xo_web_controllers_TableauViewController_readAllAsKeyValue104_invoker = createInvoker(
...
// @LINE:160
private[this] lazy val com_xo_web_controllers_TableauViewController_toggleActiveStatus105_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/toggleactive/"),DynamicPart("tableauViewId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_TableauViewController_toggleActiveStatus105_invoker = createInvoker(
...
// @LINE:161
private[this] lazy val com_xo_web_controllers_TableauViewController_readAll106_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/all"))))
private[this] lazy val com_xo_web_controllers_TableauViewController_readAll106_invoker = createInvoker(
...
// @LINE:162
private[this] lazy val com_xo_web_controllers_TableauViewController_read107_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/"),DynamicPart("tableauViewId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_TableauViewController_read107_invoker = createInvoker(
...
// @LINE:163
private[this] lazy val com_xo_web_controllers_TableauViewController_update108_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/update"))))
private[this] lazy val com_xo_web_controllers_TableauViewController_update108_invoker = createInvoker(
...
// @LINE:164
private[this] lazy val com_xo_web_controllers_TableauViewController_toggleDashboardStatus109_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/toggledashboard/"),DynamicPart("tableauViewId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_TableauViewController_toggleDashboardStatus109_invoker = createInvoker(
...
// @LINE:165
private[this] lazy val com_xo_web_controllers_TableauViewController_isDashboardExist110_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tableauview/checkdashboard/"),DynamicPart("viewGroupId", """[^/]+""",true))))
private[this] lazy val com_xo_web_controllers_TableauViewController_isDashboardExist110_invoker = createInvoker(
...
case com_xo_web_controllers_UserController_xossoCallBackHandler9_route(params) => {
   call(params.fromQuery[String]("token", None), params.fromQuery[String]("company", None), params.fromQuery[String]("domain", None), params.fromQuery[String]("name", Some("")), params.fromQuery[String]("email", Some(""))) { (token, company, domain, name, email) =>
        com_xo_web_controllers_UserController_xossoCallBackHandler9_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.UserController]).xossoCallBackHandler(token, company, domain, name, email))
   }
}
...
// @LINE:109
case com_xo_web_controllers_DashboardController_getMsisdns70_route(params) => {
   call { 
        com_xo_web_controllers_DashboardController_getMsisdns70_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.DashboardController]).getMsisdns())
   }
}
        

// @LINE:113
case com_xo_web_controllers_XoConfigTemplateController_readAll71_route(params) => {
   call { 
        com_xo_web_controllers_XoConfigTemplateController_readAll71_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).readAll())
   }
}
        

// @LINE:114
case com_xo_web_controllers_XoConfigTemplateController_create72_route(params) => {
   call { 
        com_xo_web_controllers_XoConfigTemplateController_create72_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).create())
   }
}
        

// @LINE:115
case com_xo_web_controllers_XoConfigTemplateController_read73_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigTemplateController_read73_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).read(configId))
   }
}
        

// @LINE:116
case com_xo_web_controllers_XoConfigTemplateController_update74_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigTemplateController_update74_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).update(configId))
   }
}
        

// @LINE:117
case com_xo_web_controllers_XoConfigTemplateController_delete75_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigTemplateController_delete75_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).delete(configId))
   }
}
        

// @LINE:118
case com_xo_web_controllers_XoConfigTemplateController_update76_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigTemplateController_update76_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).update(configId))
   }
}
        

// @LINE:119
case com_xo_web_controllers_XoConfigTemplateController_isConfigExist77_route(params) => {
   call(params.fromPath[String]("configShortName", None)) { (configShortName) =>
        com_xo_web_controllers_XoConfigTemplateController_isConfigExist77_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).isConfigExist(configShortName))
   }
}
        

// @LINE:120
case com_xo_web_controllers_XoConfigTemplateController_toggleActiveStatus78_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigTemplateController_toggleActiveStatus78_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigTemplateController]).toggleActiveStatus(configId))
   }
}
        

// @LINE:122
case com_xo_web_controllers_XoConfigInstanceController_create79_route(params) => {
   call { 
        com_xo_web_controllers_XoConfigInstanceController_create79_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).create())
   }
}
        

// @LINE:123
case com_xo_web_controllers_XoConfigInstanceController_readAllInstances80_route(params) => {
   call { 
        com_xo_web_controllers_XoConfigInstanceController_readAllInstances80_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).readAllInstances())
   }
}
        

// @LINE:124
case com_xo_web_controllers_XoConfigInstanceController_read81_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigInstanceController_read81_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).read(configId))
   }
}
        

// @LINE:125
case com_xo_web_controllers_XoConfigInstanceController_update82_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigInstanceController_update82_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).update(configId))
   }
}
        

// @LINE:126
case com_xo_web_controllers_XoConfigInstanceController_delete83_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigInstanceController_delete83_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).delete(configId))
   }
}
        

// @LINE:127
case com_xo_web_controllers_XoConfigInstanceController_update84_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigInstanceController_update84_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).update(configId))
   }
}
        

// @LINE:128
case com_xo_web_controllers_XoConfigInstanceController_isConfigExist85_route(params) => {
   call(params.fromPath[Integer]("configTemplateId", None), params.fromPath[String]("configShortName", None)) { (configTemplateId, configShortName) =>
        com_xo_web_controllers_XoConfigInstanceController_isConfigExist85_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).isConfigExist(configTemplateId, configShortName))
   }
}
        

// @LINE:129
case com_xo_web_controllers_XoConfigInstanceController_readAll86_route(params) => {
   call(params.fromPath[Integer]("configTemplateId", None)) { (configTemplateId) =>
        com_xo_web_controllers_XoConfigInstanceController_readAll86_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).readAll(configTemplateId))
   }
}
        

// @LINE:130
case com_xo_web_controllers_XoConfigInstanceController_toggleActiveStatus87_route(params) => {
   call(params.fromPath[Integer]("configId", None)) { (configId) =>
        com_xo_web_controllers_XoConfigInstanceController_toggleActiveStatus87_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoConfigInstanceController]).toggleActiveStatus(configId))
   }
}
        

// @LINE:134
case com_xo_web_controllers_XoClientJobConfigController_toggleActiveStatus88_route(params) => {
   call(params.fromPath[Integer]("clientId", None), params.fromPath[Integer]("jobId", None), params.fromPath[Integer]("configId", None)) { (clientId, jobId, configId) =>
        com_xo_web_controllers_XoClientJobConfigController_toggleActiveStatus88_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientJobConfigController]).toggleActiveStatus(clientId, jobId, configId))
   }
}
        

// @LINE:135
case com_xo_web_controllers_XoClientJobConfigController_runJob89_route(params) => {
   call(params.fromPath[Integer]("clientId", None), params.fromPath[Integer]("jobId", None), params.fromPath[Integer]("configId", None)) { (clientId, jobId, configId) =>
        com_xo_web_controllers_XoClientJobConfigController_runJob89_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientJobConfigController]).runJob(clientId, jobId, configId))
   }
}
        

// @LINE:136
case com_xo_web_controllers_XoClientJobConfigController_delete90_route(params) => {
   call { 
        com_xo_web_controllers_XoClientJobConfigController_delete90_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientJobConfigController]).delete())
   }
}
        

// @LINE:137
case com_xo_web_controllers_XoClientJobConfigController_readAll91_route(params) => {
   call { 
        com_xo_web_controllers_XoClientJobConfigController_readAll91_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientJobConfigController]).readAll())
   }
}
        

// @LINE:138
case com_xo_web_controllers_XoClientJobConfigController_create92_route(params) => {
   call { 
        com_xo_web_controllers_XoClientJobConfigController_create92_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientJobConfigController]).create())
   }
}
        

// @LINE:141
case com_xo_web_controllers_XoClientController_readAll93_route(params) => {
   call { 
        com_xo_web_controllers_XoClientController_readAll93_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoClientController]).readAll())
   }
}
        

// @LINE:144
case com_xo_web_controllers_XoJobController_readAll94_route(params) => {
   call { 
        com_xo_web_controllers_XoJobController_readAll94_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XoJobController]).readAll())
   }
}
        

// @LINE:146
case com_xo_web_controllers_XOBaseController_heartBeat95_route(params) => {
   call { 
        com_xo_web_controllers_XOBaseController_heartBeat95_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.XOBaseController]).heartBeat())
   }
}
        

// @LINE:149
case com_xo_web_controllers_ViewGroupController_readAllAsKeyValue96_route(params) => {
   call { 
        com_xo_web_controllers_ViewGroupController_readAllAsKeyValue96_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).readAllAsKeyValue())
   }
}
        

// @LINE:150
case com_xo_web_controllers_ViewGroupController_toggleActiveStatus97_route(params) => {
   call(params.fromPath[Integer]("viewGroupId", None)) { (viewGroupId) =>
        com_xo_web_controllers_ViewGroupController_toggleActiveStatus97_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).toggleActiveStatus(viewGroupId))
   }
}
        

// @LINE:151
case com_xo_web_controllers_ViewGroupController_delete98_route(params) => {
   call(params.fromPath[Integer]("viewGroupId", None)) { (viewGroupId) =>
        com_xo_web_controllers_ViewGroupController_delete98_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).delete(viewGroupId))
   }
}
        

// @LINE:152
case com_xo_web_controllers_ViewGroupController_readAll99_route(params) => {
   call { 
        com_xo_web_controllers_ViewGroupController_readAll99_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).readAll())
   }
}
        

// @LINE:153
case com_xo_web_controllers_ViewGroupController_read100_route(params) => {
   call(params.fromPath[Integer]("viewGroupId", None)) { (viewGroupId) =>
        com_xo_web_controllers_ViewGroupController_read100_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).read(viewGroupId))
   }
}
        

// @LINE:154
case com_xo_web_controllers_ViewGroupController_create101_route(params) => {
   call { 
        com_xo_web_controllers_ViewGroupController_create101_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).create())
   }
}
        

// @LINE:155
case com_xo_web_controllers_ViewGroupController_update102_route(params) => {
   call { 
        com_xo_web_controllers_ViewGroupController_update102_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).update())
   }
}
        

// @LINE:156
case com_xo_web_controllers_ViewGroupController_readGroupCount103_route(params) => {
   call(params.fromPath[Integer]("viewGroupId", None)) { (viewGroupId) =>
        com_xo_web_controllers_ViewGroupController_readGroupCount103_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.ViewGroupController]).readGroupCount(viewGroupId))
   }
}
        

// @LINE:159
case com_xo_web_controllers_TableauViewController_readAllAsKeyValue104_route(params) => {
   call { 
        com_xo_web_controllers_TableauViewController_readAllAsKeyValue104_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).readAllAsKeyValue())
   }
}
        

// @LINE:160
case com_xo_web_controllers_TableauViewController_toggleActiveStatus105_route(params) => {
   call(params.fromPath[String]("tableauViewId", None)) { (tableauViewId) =>
        com_xo_web_controllers_TableauViewController_toggleActiveStatus105_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).toggleActiveStatus(tableauViewId))
   }
}
        

// @LINE:161
case com_xo_web_controllers_TableauViewController_readAll106_route(params) => {
   call { 
        com_xo_web_controllers_TableauViewController_readAll106_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).readAll())
   }
}
        

// @LINE:162
case com_xo_web_controllers_TableauViewController_read107_route(params) => {
   call(params.fromPath[String]("tableauViewId", None)) { (tableauViewId) =>
        com_xo_web_controllers_TableauViewController_read107_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).read(tableauViewId))
   }
}
        

// @LINE:163
case com_xo_web_controllers_TableauViewController_update108_route(params) => {
   call { 
        com_xo_web_controllers_TableauViewController_update108_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).update())
   }
}
        

// @LINE:164
case com_xo_web_controllers_TableauViewController_toggleDashboardStatus109_route(params) => {
   call(params.fromPath[String]("tableauViewId", None)) { (tableauViewId) =>
        com_xo_web_controllers_TableauViewController_toggleDashboardStatus109_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).toggleDashboardStatus(tableauViewId))
   }
}
        

// @LINE:165
case com_xo_web_controllers_TableauViewController_isDashboardExist110_route(params) => {
   call(params.fromPath[Integer]("viewGroupId", None)) { (viewGroupId) =>
        com_xo_web_controllers_TableauViewController_isDashboardExist110_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.TableauViewController]).isDashboardExist(viewGroupId))
   }
}
        

// @LINE:168
case com_xo_web_controllers_HomeController_index111_route(params) => {
   call { 
        com_xo_web_controllers_HomeController_index111_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).index())
   }
}
        

// @LINE:169
case com_xo_web_controllers_HomeController_update112_route(params) => {
   call(params.fromPath[String]("kpi_selected", None)) { (kpi_selected) =>
        com_xo_web_controllers_HomeController_update112_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).update(kpi_selected))
   }
}
        

// @LINE:170
case com_xo_web_controllers_HomeController_get_target113_route(params) => {
   call(params.fromPath[String]("kpi_selected", None)) { (kpi_selected) =>
        com_xo_web_controllers_HomeController_get_target113_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).get_target(kpi_selected))
   }
}
        

// @LINE:171
case com_xo_web_controllers_HomeController_update_target114_route(params) => {
   call(params.fromPath[String]("segment_name", None), params.fromPath[String]("kpi_selected_name", None), params.fromPath[String]("kpi_start_value", None), params.fromPath[String]("kpi_weight_value", None)) { (segment_name, kpi_selected_name, kpi_start_value, kpi_weight_value) =>
        com_xo_web_controllers_HomeController_update_target114_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).update_target(segment_name, kpi_selected_name, kpi_start_value, kpi_weight_value))
   }
}
        

// @LINE:172
case com_xo_web_controllers_HomeController_disp115_route(params) => {
   call(params.fromPath[String]("segment", None)) { (segment) =>
        com_xo_web_controllers_HomeController_disp115_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[com.xo.web.controllers.HomeController]).disp(segment))
   }
}
