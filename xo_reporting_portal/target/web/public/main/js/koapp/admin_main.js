...
define([ 'knockout', 'main/router', 'knockout.validation', 'foundation',
        ...
        'main/tableaumanagement', 'main/configuration_mgmt', 'main/job_mgmt', 'main/rlp_mgmt', 'main/reports_management', 'main/report_group_management','main/config_kpi'],
   function(ko, Router, kv, foundation, datatables, DataTable, Responsive, UserManagerModel, 
         ...
         TableauManagerModel, ConfigurationManagerModel, JobManagerModel, RowLevelPermissionModel, ReportManagementModel, ReportGroupManagementModel,ConfigKPITargetModel) {
    ...
    var initializePages = function(){
      ...
      var urlMapping = {        
        ...
        configkpi: {match: /^configkpi$/, page: configkpiPage},
	  ...
	  var configkpi = new ConfigKPITargetModel();
      ...
      function configkpiPage() {
          	  return showPageLoader(function() {
      				return new Router.Page('Xoanon Analytics Reporting Portal',	'config_kpi', { configkpi:configkpi });
      			});
            }            
